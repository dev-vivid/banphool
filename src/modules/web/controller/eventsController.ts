...
import eventsUseCase from "../usecase/eventsUseCase";
...
export const getAll = async (
  ...
  try {
    const { data, pagination } = await eventsUseCase.getAll(req.query);
...
export const getById = async (
  ...
  try {
    const data = await eventsUseCase.getById(req.params.id);
...
export const create = async (
  ...
  try {
    ...
    const data = await eventsUseCase.create(body, req);
...
export const update = async (
  ...
  try {
    ...
    const data = await eventsUseCase.update(req.params.id, body, req);
...
export const remove = async (
  ...
  try {
    await eventsUseCase.remove(req.params.id, req);
