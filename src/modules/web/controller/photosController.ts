...
import photosUseCase from "../usecase/photosUseCase";
...
export const getAll = async (
  ...
  try {
    const { data, pagination } = await photosUseCase.getAll(req.query);
...
export const getById = async (
  ...
  try {
    const data = await photosUseCase.getById(req.params.id);
...
export const create = async (
  ...
  try {
    ...
    const data = await photosUseCase.create(body, req);
...
export const update = async (
  ...
  try {
    ...
    const data = await photosUseCase.update(req.params.id, body, req);
...
export const remove = async (
  ...
  try {
    await photosUseCase.remove(req.params.id, req);
...
export const updateStatus = async (
  ...
  try {
    const data = await photosUseCase.updateStatus(
      req.params.id,
      req.body.isActive,
      req
    );
